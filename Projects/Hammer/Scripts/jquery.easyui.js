...
(function ($) {
    ...
    }, beforePageText: "第", afterPageText: "共 {pages} 页", displayMsg: "显示 {from} 到 {to}, 共 {total} 条记录"
    };
})(jQuery);
(function ($) {
    function _7d(_7e) {
